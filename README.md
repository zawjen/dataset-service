...
```env
IS_MOCK=true # For mock data
IS_MOCK=false # For actual data
```
...
```json
{
  "datasets": [
    ...
    {
      "id": "7f8d9a2b-3c4e-5f6g-7h8i-9j0k1l2m3n4o",
      "name": "Sample Dataset 2",
      "description": "Historical weather data for major cities",
      "tags": ["weather", "climate", "historical"],
      "status": "draft",
      "date_created": "2023-08-14T10:15:00Z",
      "created_by": "weather.team@example.com",
      "date_modified": "2023-08-14T10:15:00Z",
      "modified_by": "weather.team@example.com"
    }
  ]
}
